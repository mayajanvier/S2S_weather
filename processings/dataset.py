...
class WeatherYearEnsembleDataset:
    ...
    def __init__(
        ...
        self.scaler_path = f"/home/majanvie/scratch/loader/{subset}_scaler.nc"
        self.scaler_truth_path = f"/home/majanvie/scratch/loader/{subset}_scaler_truth.nc"
